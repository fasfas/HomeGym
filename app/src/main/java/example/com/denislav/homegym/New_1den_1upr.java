...
public class New_1den_1upr extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_1den_1upr);
        ...
        myWebView.loadUrl("http://prikachi.com/images/313/8527313L.png");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        else if (id == R.id.nav_upr5) {
            startActivity(new Intent(this, New_1den_5upr.class));
            finish();
