...
public class New_1den_5upr extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_1den_5upr);
        ...
        myWebView.loadUrl("http://prikachi.com/images/322/8527322P.png");
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == next.getId()) {
            Toast.makeText(getApplicationContext(), "БРАВО! ЗАВЪРШИ ПЪРВИЯ ДЕН ОТ ПРОГРАМАТА!", Toast.LENGTH_LONG).show();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        }else if (id == R.id.nav_upr2) {
            startActivity(new Intent(this, New_1den_2upr.class));
            finish();

        } else if (id == R.id.nav_upr3) {
            startActivity(new Intent(this, New_1den_3upr.class));
            finish();

        } else if (id == R.id.nav_upr4) {
            startActivity(new Intent(this, New_1den_4upr.class));
            finish();
