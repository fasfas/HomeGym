...
public class New_2den_7upr extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_2den_7upr);
        ...
        myWebView.loadUrl("http://prikachi.com/images/309/8527309D.png");
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == next.getId()) {
            Toast.makeText(getApplicationContext(), "БРАВО! ЗАВЪРШИ ВТОРИЯ ДЕН ОТ ПРОГРАМАТА!", Toast.LENGTH_LONG).show();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_upr1_den2) {
            ...
            startActivity(new Intent(this, New_2den_3upr.class));
            finish();
